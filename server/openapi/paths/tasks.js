    ...
    '/api/v1/tasks': {
      ...
      get: op({
        ...
        params: [
          ...
          { name: 'include_future', in: 'query', required: false, schema: { type: 'string' }, description: 'Use 1 to include scheduled work before its household-local start date and time. Ordinary Task lists exclude not-yet-started Tasks and linked helper projections; missing Start Time means household-local midnight.' },
        ],
      }),
