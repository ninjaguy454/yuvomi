  ...
  return {
    '/api/v1/pantry': {
      get: op({
        ...
        tag: 'Pantry',
        description: 'Each item includes optional `sku` and `preferred_store_place_id`; the response also includes `store_places` for the preferred-store selector. A preferred store is a reusable Vidamia Place whose type is `store`.',
      }),
      post: op({
