...
test('eine Adressliste im Kontakt macht niemanden erreichbar (#944)', async () => {
  ...
  for (const wert of [
    'a@example.org,fremd@example.com', 'a@example.org; b@example.org', 'a@example.org fremd@x.de',
    'a@example.org\r\nBcc: stranger@example.com', 'Name<a@example.org>', 'a@localhost',
    'a@.example.org', 'a@example..org', 'a@-example.org', 'a@example:25.org',
    '.a@example.org', 'a..b@example.org', `${'a'.repeat(255)}@example.org`,
  ]) {
