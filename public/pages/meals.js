...
function renderMealPlanRule(rule = {}) {
  ...
  return `<details class="meal-plan-rule" data-plan-rule data-rule-sequence="${sequence}" data-rule-id="${Number(rule.id) || ''}" data-rule-key="${esc(rule.rule_key || '')}" data-slot-group-key="${esc(rule.slot_group_key || '')}" open>
    ...
    <div class="meal-plan-rule__body">
      ...
      <details class="meal-plan-rule__section" data-rule-section="what" open><summary><span><strong>${mealText('meals.sectionWhat', 'What')}</strong><small>${mealText('meals.sectionWhatHint', 'Choose the practical Tasks Vidamia creates when this meal is prepared.')}</small></span><i data-lucide="chevron-down" class="icon-sm" aria-hidden="true"></i></summary><div class="meal-plan-rule__section-body">
      ...
      <details class="meal-plan-rule__section" data-rule-section="deadlines" open><summary><span><strong>${mealText('meals.sectionDeadlines', 'Deadlines')}</strong><small>${mealText('meals.sectionDeadlinesHint', 'Set when meal choices are due and when Vidamia reminds people.')}</small></span><i data-lucide="chevron-down" class="icon-sm" aria-hidden="true"></i></summary><div class="meal-plan-rule__section-body">
...
function openMealScheduleModal() {
  ...
  const content = `<form id="meal-schedule-form">
    <p class="form-hint">Set the household's normal meal windows, then turn on the weekday slots you want Vidamia to prepare automatically. Generated meals remain editable for that date.</p>
