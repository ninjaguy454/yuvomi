...
function renderMealPlanRule(rule = {}) {
  ...
  return `<details class="meal-plan-rule" data-plan-rule data-rule-sequence="${sequence}" data-rule-id="${Number(rule.id) || ''}" data-rule-key="${esc(rule.rule_key || '')}" data-slot-group-key="${esc(rule.slot_group_key || '')}" open>
    ...
    <div class="meal-plan-rule__body">
      ...
      <details class="meal-plan-rule__section" data-rule-section="who" open><summary><span><strong>${mealText('meals.sectionWho', 'Who')}</strong><small>${mealText('meals.sectionWhoHint', 'Choose who decides, participates, cooks, and supervises.')}</small></span><i data-lucide="chevron-down" class="icon-sm" aria-hidden="true"></i></summary><div class="meal-plan-rule__section-body">
        <fieldset class="meal-plan-responsibility-group" data-plan-chooser-group><legend>${mealText('meals.chooserResponsibility', 'Chooser responsibility')}</legend>
          ...
          <div class="meal-plan-fallbacks" data-plan-fallbacks ${rule.policy === 'personal_choice' ? 'hidden' : ''}>
            <div><strong>${mealText('meals.fixedBackupOrder', 'Fixed backup order')}</strong><small>${mealText('meals.fixedBackupOrderHint', 'If the chooser cannot decide, Ordoma tries these people in order, then uses the household default failsafe.')}</small></div>
      ...
      <details class="meal-plan-rule__section" data-rule-section="what" open><summary><span><strong>${mealText('meals.sectionWhat', 'What')}</strong><small>${mealText('meals.sectionWhatHint', 'Choose the practical Tasks Ordoma creates when this meal is prepared.')}</small></span><i data-lucide="chevron-down" class="icon-sm" aria-hidden="true"></i></summary><div class="meal-plan-rule__section-body">
      ...
      <details class="meal-plan-rule__section" data-rule-section="deadlines" open><summary><span><strong>${mealText('meals.sectionDeadlines', 'Deadlines')}</strong><small>${mealText('meals.sectionDeadlinesHint', 'Set when meal choices are due and when Ordoma reminds people.')}</small></span><i data-lucide="chevron-down" class="icon-sm" aria-hidden="true"></i></summary><div class="meal-plan-rule__section-body">
...
function openMealScheduleModal() {
  ...
  const content = `<form id="meal-schedule-form">
    <p class="form-hint">Set the household's normal meal windows, then turn on the weekday slots you want Ordoma to prepare automatically. Generated meals remain editable for that date.</p>
