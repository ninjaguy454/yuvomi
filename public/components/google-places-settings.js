...
export async function renderGooglePlacesSettings(container, {
  ...
  replaceHtml(container, `<form data-google-places-config>
    <p class="settings-card-description">Google search is optional. The API key stays on the Vidamia server and is never returned to the browser after it is saved.</p>
