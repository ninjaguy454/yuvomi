...
export const PERMISSION_CAPABILITIES = Object.freeze([
  ...
  ...[
    ['view','View Rotation Groups','read','allow'],
    ['manage','Create and edit Rotation Groups','write','none'],
    ['configure','Configure Activity, Workflow and Meal rotations','write','none'],
    ['override','Override a Rotation Occurrence','write','none'],
    ['advance','Finalize, skip or manually advance rotations','write','none'],
    ['correct','Correct the next rotation position','write','none'],
    ['history','View Rotation history','read','allow'],
  ].map(([key,label,access,defaultAccess])=>({key:`rotations.${key}`,label,access,default:defaultAccess,module:null,group:'Rotations'})),
