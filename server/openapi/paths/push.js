...
export function pushPaths() {
  return {
    ...
    '/api/v1/push/status': { post: op({ summary: 'Check whether this browser subscription belongs to the current user', tag: 'Push', stateChanging: true, requestBody: jsonBody(null) }) },
