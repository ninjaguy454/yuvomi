...
import { startTaskExpiration } from './services/task-expiration.js';
import { startSharedRotationScheduler } from './services/rotation-shared-scheduler.js';
...
app.use('/api/v1/automation', rotationsRouter);
