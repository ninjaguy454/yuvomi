<div align="center">
  ...
  <p>Vidamia ist eine eigenständige Plattform für die Haushaltsorganisation, die aus dem Open-Source-Projekt <a href="https://github.com/ulsklyc/yuvomi">Yuvomi</a> hervorgegangen ist. MIT-Lizenz und Urheberrechtshinweise des Ursprungsprojekts bleiben erhalten.</p>
  ...
  <p><small>Die Screenshots zeigen die frühere Yuvomi-Oberfläche als Referenz. Vidamia ergänzt eigene Haushaltsabläufe und visuelle Verbesserungen.</small></p>
...
Konto, eigenem Abo und einer eigenen Kopie deiner Daten auf fremden Servern. Vidamia bringt das alles
...
| Statt zu jonglieren mit… | gibt dir Vidamia |
|---|---|
...
| **Verfügbarkeit** | Im Kalender öffnen: wöchentliche Routinen, wechselnde Wochen und Routinen mit einem Rhythmus von N Tagen, mit datierten Ausnahmen und freien Tagen. Erklärte Verfügbarkeitsfenster fließen bei aktivierter Verfügbarkeitsregel in die Eignung für aktivitätsbasierte Aufgaben ein. Ein freier Tag hebt nur die Einschränkung dieser Routine auf. Der Kalender bleibt eine schreibgeschützte Darstellung; bestehende Schedule-Tabellen, Schichttypen, Ausnahmen und Statistiken bleiben erhalten. |
...
Hänge `/reader` an deine normale Vidamia-Adresse an. Dort gibt es eine schlanke,
...
LAN-Namen oder die LAN-Adresse des Vidamia-Servers statt `127.0.0.1`, denn diese Adresse bezeichnet
...
> **Vidamia-Veröffentlichung.** Die folgenden Befehle, Registry-Links und App-Store-Verweise verwenden weiterhin die Paketkennungen des Ursprungsprojekts Yuvomi. Sie installieren für sich genommen keine Vidamia-Version. Vidamia wird mit dem geprüften Image dieses Forks und der bestehenden Konfiguration sowie den vorhandenen Datenvolumes betrieben.
...
> **Externer Dokumentenspeicher braucht eine eigene Sicherung.** Datenbank-Backups enthalten Metadaten und Verknüpfungen, nicht die Dateien selbst, wenn sie in einem lokalen Ordner, auf WebDAV oder in Google Drive liegen; sichere das gewählte Ziel separat. Vidamias Sichtbarkeitseinstellungen regeln nur den Zugriff über Vidamia. Wer Zugriff auf den verbundenen Google-Drive-Ordner `Yuvomi/Documents` hat, sieht alle dort abgelegten Dateien.
...
> **Die Paketnamen des Ursprungsprojekts bleiben erhalten.** Katalogeinträge und Images namens `yuvomi` oder `oikos` gehören zu Yuvomi und sind keine eigene Vidamia-Veröffentlichung. Vidamia wird aus dem geprüften Image dieses Forks betrieben; bestehende technische Kennungen bleiben kompatibel.
...
**Was, wenn dieses Projekt aufhört?** Auf deiner Maschine ändert sich nichts. Vidamia ist
...
**Was kostet es?** Nichts. Vidamia ist kostenlos und MIT-lizenziert. Du stellst den Server; es gibt
...
- **24 Sprachen** mit automatischer Erkennung. Eine eigene Haushaltseinstellung bestimmt die Sprache der Einträge, die Vidamia selbst anlegt - so spricht ein exportierter Kalender die Sprache deines Haushalts statt Englisch.
...
Wenn du Vidamia im DSGVO-Kontext betreibst (EU/EWR, Verarbeitung fremder Daten), lies vorher
...
Das Ursprungsprojekt Yuvomi wurde von **Oikos** umbenannt, um einen Markenkonflikt mit einem unabhängigen Produkt zu vermeiden. Vidamia ist ein unabhängig weiterentwickelter Fork; diese frühere Umbenennung ist davon getrennt.
