  ...
  return {
    ...
    '/api/v1/recipes/markdown-preview': {
      post: op({
        ...
        stateChanging: true,
        requestBody: jsonBody(null),
        description: 'Body: { markdown, source_url? }. Parses the shareable Vidamia Markdown format without saving a Recipe. Markdown export itself is client-side and therefore has no separate API route.',
      }),
    },
    '/api/v1/recipes/{id}': {
